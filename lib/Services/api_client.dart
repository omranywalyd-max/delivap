...
class ApiClient {
  ...
  static DateTime? _tokenCachedAt;
  ...
  static Future<Map<String, String>> _headers() async {
    ...
    if (_customToken != null) {
      ...
      if (_cachedFirebaseToken != null && _tokenCachedAt != null && now.difference(_tokenCachedAt!).inMinutes < 50) {
        headers['Authorization'] = 'Bearer $_cachedFirebaseToken';
      } else {
